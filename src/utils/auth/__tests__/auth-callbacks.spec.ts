...
vi.mock('../oauth-refresh', async (importOriginal) => {
  const actual = await importOriginal<typeof import('../oauth-refresh')>();
  return {
    ...actual,
...
const mockRefreshOAuthToken = vi.mocked(refreshOAuthToken);
